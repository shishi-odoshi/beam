...
#
# Contract fixture: heartbeats with the REAL OtpRails::Heartbeat helper from
# the published otp-rails gem — not a hand-rolled socket writer — so the beam
...
hb = OtpRails::Heartbeat.new(id: id, interval: interval)
abort "not supervised: OTP_RAILS_SOCK / OTP_RAILS_TOKEN missing" unless hb.start
